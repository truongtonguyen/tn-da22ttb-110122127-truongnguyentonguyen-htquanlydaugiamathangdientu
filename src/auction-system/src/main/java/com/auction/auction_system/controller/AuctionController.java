...
public class AuctionController {
    ...
    // =========================
    // GET ALL AUCTIONS (PAGINATION + CATEGORY FILTER)
    // categoryId là tùy chọn — nếu không truyền thì lấy tất cả
    // =========================
    @GetMapping
    public Page<Auction> getAll(
        ...
        return auctionService.getAllAuctions(page, size, categoryId);
    }
    ...
    public List<Auction> getMyAuctions(Authentication authentication) {
        User seller = (User) authentication.getPrincipal();
        return auctionService.getMyAuctions(seller);
    }
    ...
    public Page<Auction> searchAuctions(
        ...
        return auctionService.searchAuctions(keyword, status, page, size);
    }
